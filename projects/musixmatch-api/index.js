...
export class Page extends HTML {
  ...
  onSendButtonClick() {
    ...
    console.log('on Send Button Click', { method, url, query })
    const q = Array.from(query).map((q, ix) => [q, this.children.inputs.children[q].children.input.getValue()].join('=')).join('&')
